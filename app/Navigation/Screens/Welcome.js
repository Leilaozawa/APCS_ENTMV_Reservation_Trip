        ...
        >
            <View style={styles.container}>
                ...
                <View style={styles.buttonsContainer}>
                    <TouchableOpacity style={styles.connexionButton} onPress={()=> router.push('/Navigation/Screens/Login')}/*onPress={() => navigate("Login")}*/>
                        <Text style={styles.connexionText}>Se connecter</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.accessButton} /*onPress={() => navigate("MainContainer")}*/>
